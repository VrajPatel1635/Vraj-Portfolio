                ...
                {projects.map((project, index) => (
                    <Tilt key={index}>
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-[#1f2d2b] via-[#2c3e50] to-[#1a252f] p-6 rounded-2xl shadow-md ring-1 ring-sky-400/20 transition-all hover:ring-sky-300/40 hover:shadow-sky-700/20"
